...
public class AimController : MonoBehaviour
{
    ...
    [SerializeField]
    private LifeAndUIMgr[] lifeAndUI = new LifeAndUIMgr[1];

    [HideInInspector]
    public Vector3 targetPos;

    [SerializeField]
    private RaycastHit msHit;
    public RaycastHit GetMouseHit() { return msHit; }
    [SerializeField]
    private RaycastHit blHit;
    public RaycastHit GetBulletHit() { return blHit; }
